...
namespace Lab3
{
    public partial class Euler : Form
    {
        ...
        private float radius = 2.5f;  // Радиус окружности
        private float a = 2f, b = 3f; // Полуоси эллипса
        ...
        { 
            ...
            {
                float xCircle = radius * (float)Math.Cos(t);
                float yCircle = radius * (float)Math.Sin(t);
